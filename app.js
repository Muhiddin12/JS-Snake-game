...
document.addEventListener('keydown', function(e) {
  if(e.keyCode === 37 && snake.dx === 0){  // for left key
    snake.dx = -grid;
    snake.dy = 0
  } else if(e.keyCode === 38 && snake.dy === 0){  // for up key
    snake.dy = -grid;
    snake.dx = 0
  } else if(e.keyCode === 39 && snake.dx === 0){  // for right key
    snake.dx = grid;
    snake.dy = 0
  } else if(e.keyCode === 40 && snake.dy === 0){  // for down key
    snake.dy = grid;
    snake.dx = 0
  } 
})
